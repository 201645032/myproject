...
ResultSet rs = stmt.executeQuery("select code from travel where name ='"+title+"' "); 
	stmt.executeUpdate("update travel set name = '"+title+"', api = '"+api+"', info = '"+info+"', hash1 = '"+hash1+"', hash2 = '"+hash2+"', hash3 = '"+hash3+"',hash4 = '"+hash4+"' where code = "+code+" ");
