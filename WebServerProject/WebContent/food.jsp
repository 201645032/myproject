...
try{
	...
	ResultSet rs2 = stmt.executeQuery("select count(code) from food");
	while(rs2.next()){
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <!-- // nav bar 부분 끝 -->   
     ...
     <div id="travel">
        ...
        <%
		ResultSet rs4 = stmt3.executeQuery("select distinct code from food where love limit 5");    
     	for(int i = 0; i<5; i++){
     		if(rs4.next()){
     			int topcode = rs4.getInt(1);	
        			ResultSet rs5 = stmt4.executeQuery("select name,hash1,hash2,hash3,hash4 from food where code="+topcode+"");
        			if(rs5.next()){
        				...
        				ResultSet rs6 = stmt5.executeQuery("select image1 from foodimageaddr where imagecode="+topcode+" ");
        				if(rs6.next()){
        			...
        			%>
                        <div class="col-xs-2 col-md-2">
                         <div class="thumbnail">
                            <a href="foodboard.jsp?code=<%=topcode %>" data-backdrop="static" data-keyboard="false">
              ...
              <div class="carousel-inner">
                <div class="item active">
                   <div class="row"> <!-- 슬라이드 one --> 
                   		<div class="col-xs-1 col-md-1"><p></div>
                   		<%try{
                   		ResultSet w1 = stmt6.executeQuery("select distinct code from food where hash3 = '겨울' limit 5");
                   		for(int i=0; i<5; i++){
                   			if(w1.next()){
                   				int w_code = w1.getInt(1);
                   				ResultSet w2 = stmt7.executeQuery("select name,hash1,hash2,hash3,hash4 from food where code="+w_code+"");
                   				if(w2.next()){
                				...
                				ResultSet w3 = stmt8.executeQuery("select image1 from foodimageaddr where imagecode="+w_code+" ");
                				if(w3.next()){
                        ...
                        <div class="col-xs-2 col-md-2">
                         <div class="thumbnail">
                            <a  href="foodboard.jsp?code=<%=w_code %>">
                            <img src="./imgs/Food/<%=image1 %>" alt="..."></a>
                            <div class="caption">
                              <h4><b><%=title %></b></h4>
                              <p>#<%=hash1 %>#<%=hash2%> #<%=hash3%> #<%=hash4%></p>
              ...
              <div class="carousel-inner">
               ...
               <%
					...
					for(int i = 1; i<allcount; i++){
						...
						rs2 = stmt.executeQuery("select image1 from foodimageaddr where imagecode="+i+" ");
						if(rs2.next()){
							t_image[i] = rs2.getString(1);
							
						}
						rs3 = stmt.executeQuery("select name,hash1,hash2,hash3,hash4 from food where code="+i+"");
						if(rs3.next()){
                        ...
                        <div class="col-xs-2 col-md-2">
                         <div class="thumbnail">
                            <a href="foodboard.jsp?code=<%=i%>" data-backdrop="static" data-keyboard="false">
                            <img src="./imgs/Food/<%=t_image[i] %>" alt="..."></a>
                            <div class="caption">
                              <h4><b><%=t_title[i]%></b></h4>
 ...
 <a href="food_write.jsp"><span class="glyphicon glyphicon-pencil icons"> </span></a>
 </div>
