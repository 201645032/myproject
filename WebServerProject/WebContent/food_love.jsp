...
stmt.executeUpdate("insert into love values('"+session.getAttribute("_id")+"',"+code+")");
stmt2.executeUpdate("update food set love = love+1 where code = "+code+"");
rs = stmt3.executeQuery("select id from love where id = '"+session.getAttribute("_id")+"'");
if(rs.next()){
