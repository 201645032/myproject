...
<body>
 ...
 try{
     ...
     ResultSet rs1 = stmt.executeQuery("select * from food where code ="+code+"");
     if(rs1.next()){
     ...
     ResultSet rs3 = stmt.executeQuery("select * from foodimageaddr where imagecode="+code+"");
     if(rs3.next()){
...
<!-- write modal -->
  <form action = "uploadfood_mod.jsp?code=<%=code %>" method = "post" enctype = "multipart/form-data">
  <div class ="top_line">
  <h1>게시글 수정</h1>
  <div class="modal-dialog modal-fullsize">
    <div class="modal-content">
	...
	<details>
      ...
      <div class="modal-footer">
        ...
        <a href="foodboard.jsp?code=<%=code%>"><button type="button" class="btn btn-default">닫기</button></a>
