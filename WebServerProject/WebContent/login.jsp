...
try{
	...
	if(rs.next()){
		 ...
		 if(id.equals(userid)&&pw.equals(userpw)){
			 stmt.executeUpdate("update users set login = '1' where id = '"+id+"'");
			 session.setAttribute("_id", id);
			 response.sendRedirect("main.jsp");
		 }
		
	}
	else{p = "계정 정보가 일치하지 않습니다.";}
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class = "login1"><h1>로그인 </h1>
     <div class = "loginform">
    <div class="input-group">
        <span class="input-group-addon"> <span class="glyphicon glyphicon-user"> </span> </span>
        <input type="text" size = "10" name = "_id" class="form-control" placeholder="아이디">
    </div> 
     <br>
    <div class="input-group">
        <span class="input-group-addon">  <span class="glyphicon glyphicon-lock"></span> </span>
        <input type="password" name = "_pw" class="form-control" placeholder="암 호"><br>
